...
Gem::Specification.new do |s|
  ...
  s.description = %q{RailsAdmin is a Rails engine that provides an easy-to-use interface for managing your data.  This is a customized version for MITRE's HPRS project.}
